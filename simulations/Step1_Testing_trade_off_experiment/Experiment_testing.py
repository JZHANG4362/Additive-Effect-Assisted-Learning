...
def experiment_test(Model, hypothesis, statCal, randomBeta, mechanism, XBound, LapEpsilon, Xdist, Umatrix, testtype, sig, n, K, ResponseGenVec, fitmodel, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3):
    ...
    for i in range(K):
        ...
        UK = Umatrix[:,0:(i+1)]
        UKXB_tmp = np.dot(XB,  UK)
        #============================add noise=========================
        if mechanism == "Laplace":
            Lapscale = 2*(i+1)*XBound/LapEpsilon
            UKXB = UKXB_tmp + np.random.laplace(loc=0, scale=Lapscale, size=UKXB_tmp.shape)
        if mechanism == "Gaussian":
            deltaInv = (n+1)*(i+1)
            GaussScale = math.sqrt(math.log(1.25*deltaInv)) * XBound * (i+1)/LapEpsilon
            UKXB = UKXB_tmp + np.random.normal(loc=0, scale=GaussScale, size=UKXB_tmp.shape)


        XAintercept_add_tmp = np.concatenate((XAintercept, UKXB), axis = 1)
...
def repexperiment_test(Model, hypothesis, statCal, randomBeta, mechanism, XBound, LapEpsilon, Xdist, fixedU, testtype, sig, niter, n, K, ResponseGenVec, fitmodel, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3):
    p2 = p2_1 + p2_2 + p2_3
    p3 = p3_1 + p3_2 + p3_3
    p23 = p2 + p3
    ...
    for j in range(niter):
        ...
        if fixedU == True:
            ...
            Umatrix = u_tmp/L2Norms
        print("iter: " + str(j))
        pVList, rejList = experiment_test(Model, hypothesis, statCal, randomBeta, mechanism, XBound, LapEpsilon, Xdist, Umatrix, testtype, sig, n, K, ResponseGenVec, fitmodel, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)
