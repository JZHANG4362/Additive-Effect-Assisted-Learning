...
def experiment(Model, randomBeta, Xdist, sig, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3):
...
def repExperiment(Model,randomBeta, Xdist, sig, niter, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3):
    ...
    for j in range(niter):
        ...
        if reportAUC:
            if reportll:
                AUCList, EuDisList, llList, AUC_oracle, ll_oracle  = experiment(Model,randomBeta, Xdist, sig, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)
            else:
                AUCList, EuDisList, AUC_oracle  = experiment(Model,randomBeta, Xdist, sig, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)
        elif reportll:
            EuDisList, llList, ll_oracle  = experiment(Model,randomBeta, Xdist, sig, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)
        else:
            EuDisList  = experiment(Model,randomBeta, Xdist, sig, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)
