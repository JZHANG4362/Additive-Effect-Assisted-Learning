...
parser.add_argument("--Model", default="logistic", type=str, help="logistic, normal, poisson, or logcosh")
                ...
                for Index in IndexList:
                    ...
                    if reportAUC:
                        if reportll:
                            ...
                            AUC_array, EuDis_array, ll_array, AUC_oracle_array, ll_oracle_array = repExperiment(Model, randomBeta, Xdist, sig, niter, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)

                            #==============================================export the results===============================================
                            result = {"EuDis": EuDis_array, "ll": ll_array, "AUC": AUC_array, "ll_oracle": ll_oracle_array , "AUC_oracle": AUC_oracle_array}
                        else:
                            AUC_array, EuDis_array, AUC_oracle_array =  repExperiment(Model, randomBeta, Xdist, sig, niter, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)

                            #==============================================export the results===============================================
                            result = {"EuDis": EuDis_array, "AUC": AUC_array,  "AUC_oracle": AUC_oracle_array}
                    elif reportll:
                        # obtain the evaluation results
                        EuDis_array, ll_array, ll_oracle_array =  repExperiment(Model, randomBeta, Xdist, sig, niter, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)

                        #==============================================export the results===============================================
                        result = {"EuDis": EuDis_array, "ll": ll_array,  "ll_oracle": ll_oracle_array}
                    else:
                        # obtain the evaluation results
                        EuDis_array =  repExperiment(Model, randomBeta, Xdist, sig, niter, n, nEval, invLinkVec, loglikeli, ResponseGenVec, fitmodel, reportAUC, reportll, kNum, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)
