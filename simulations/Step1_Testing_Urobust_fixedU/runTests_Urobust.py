...
from Experiment_testing_Urobust import repexperiment_test
                ...
                for n in nList:
                    for Index in IndexList:
                        ...
                        for Uind in range(nU):
                            ...
                            pV_array, rej_array = repexperiment_test(Model, hypothesis, statCal, randomBeta, Lapscale, Xdist, testtype, sig, niter, n, K, ResponseGenVec, fitmodel, Uind, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3)
                            
                            # file name
                            fname = Model + "_Setting_" + str(Index) + "_n_" + str(n) + "_Lapscale_" + str(Lapscale) + "_sig_" + str(sig) + "_Xdist_" + str(Xdist) + "_testtype_" + testtype + "_fixedU_"  + "_randomBeta_" + randomBeta + "_Uind_" + str(Uind)
