...
def repexperiment_test(Model, hypothesis, statCal, randomBeta, Lapscale, Xdist, testtype, sig, niter, n, K, ResponseGenVec, fitmodel, Uind, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3, p1_1, p1_2, p1_3, p2_1, p2_2, p2_3, p3_1, p3_2, p3_3):
    p2 = p2_1 + p2_2 + p2_3
    p3 = p3_1 + p3_2 + p3_3
    p23 = p2 + p3
    
    # in this experiment, we always fix the U
    fixedU = True
    ...
    for j in range(niter):
        ...
        #=============fix the U for all the replications============
        if fixedU == True:
            Umatrix = new_dict[Uind, :, :]
        elif fixedU == False:
            # generate normal random values
            u_tmp = np.random.normal(loc = 0, scale = 1, size = (p23, K))
            # standardize each column
